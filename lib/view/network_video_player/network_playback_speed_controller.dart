...
class NetworkPlaybackSpeedController extends StatefulWidget {
  const NetworkPlaybackSpeedController({super.key});

  @override
  State<NetworkPlaybackSpeedController> createState() => _NetworkPlaybackSpeedControllerState();
}

class _NetworkPlaybackSpeedControllerState extends State<NetworkPlaybackSpeedController> {
